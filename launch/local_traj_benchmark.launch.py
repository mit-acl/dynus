    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'playback_period_sec': LaunchConfiguration('playback_period_sec'),
                'use_single_threaded': LaunchConfiguration('use_single_threaded'),
                'planner_names': LaunchConfiguration('planner_names'),
                'num_N_list': LaunchConfiguration('num_N_list'),
                'factor_initial_list': LaunchConfiguration('factor_initial_list'),
                'factor_final_list': LaunchConfiguration('factor_final_list'),
                'using_variable_elimination': LaunchConfiguration('using_variable_elimination'),
                'output_dir_override': LaunchConfiguration('output_dir_override'),
