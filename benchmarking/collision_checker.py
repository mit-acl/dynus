...
def main():
    if len(sys.argv) < 6:
        ...
        print("Example: python3 collision_checker.py /home/kkondo/data/hard_forest_obstacle_parameters.csv /media/kkondo/T7/sando/static/hard_forest/bags/sando 0.1 /NX01/goal dynus_interfaces/msg/Goal")
        sys.exit(1)
