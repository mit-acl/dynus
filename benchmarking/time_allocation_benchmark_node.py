...
class BenchmarkNode(Node):
    ...
    def __init__(self):
        ...
        # Benchmarking types
        self.benchmark_types = 'time_allocation'
        self.time_allocation_algorithms = ['dynus', 'faster_4', 'faster_5', 'faster_6']
    ...
    def run_simulation(self):
        ...
        # algorithm loop
        for time_allocation_algorithm in self.time_allocation_algorithms:
            ...
            for i in range(self.iterations):
                ...
                self.start_simulation(self.algorithm, csv_folder_path, bag_folder_path, time_allocation_algorithm)
                result = self.wait_for_goal()
                self.log_info(result, time_allocation_algorithm, i, log_folder_path)
    ...
    def start_simulation(self, global_planner_algorithm='dgp', csv_folder_path='', bag_folder_path='', time_allocation_algorithm='dynus'):
        ...
        # Set parameters
        always_use_miqp = True if time_allocation_algorithm == 'faster_4' or time_allocation_algorithm == 'faster_5' or time_allocation_algorithm == 'faster_6' else False
        num_N = 4 if time_allocation_algorithm == 'faster_4' else 5 if time_allocation_algorithm == 'faster_5' else 6
