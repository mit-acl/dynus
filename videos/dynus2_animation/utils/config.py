...
SPATIAL_CORRIDORS_2D = [
    # Around x0 → x1
    [np.array([3.0, -3.0, 0]), np.array([2.0, -3.0, 0]),
     np.array([0.5, -0.3, 0]), np.array([1.5, -0.3, 0])],
    # Around x1 → x2
    [np.array([1.5, -1.3, 0]), np.array([0.3, -1.3, 0]),
     np.array([-1.0, 1.3, 0]), np.array([0.2, 1.3, 0])],
    # Around x2 → x3
    [np.array([0.2, 0.3, 0]), np.array([-1.2, 0.3, 0]),
     np.array([-1.2, 3.2, 0]), np.array([0.2, 3.2, 0])],
]
...
CORRIDORS_3D_T0 = {
    (0, 0): _make_corridor(
        [[2.0, -3.0], [3.2, -3.0], [3.2, -1.5], [2.0, -1.5]], 0, 1),
    (1, 0): _make_corridor(
        [[1.5, -1.5], [2.5, -1.5], [2.0, -0.2], [1.0, -0.2]], 0, 1),
    (1, 1): _make_corridor(
        [[0.5, -1.2], [1.8, -1.2], [1.2, 0.3], [0.0, 0.3]], 1, 2),
    (2, 1): _make_corridor(
        [[-0.2, -0.2], [1.0, -0.2], [0.5, 1.2], [-0.8, 1.2]], 1, 2),
    (2, 2): _make_corridor(
        [[-1.0, 0.5], [0.3, 0.5], [0.0, 1.8], [-1.3, 1.8]], 2, 3),
    (3, 2): _make_corridor(
        [[-1.2, 1.5], [0.2, 1.5], [0.2, 3.2], [-1.2, 3.2]], 2, 3),
}

# Corridors for t=t1 replan (C'[i][j])
CORRIDORS_3D_T1 = {
    (0, 0): _make_corridor(
        [[1.8, -2.8], [3.0, -2.8], [3.0, -1.3], [1.8, -1.3]], 0, 1),
    (1, 1): _make_corridor(
        [[0.8, -1.5], [2.0, -1.5], [1.5, 0.0], [0.3, 0.0]], 1, 2),
    (2, 1): _make_corridor(
        [[-0.5, -0.5], [0.8, -0.5], [0.3, 1.0], [-1.0, 1.0]], 1, 2),
    (2, 2): _make_corridor(
        [[-1.3, 0.8], [0.0, 0.8], [-0.3, 2.0], [-1.6, 2.0]], 2, 3),
    (3, 2): _make_corridor(
        [[-1.5, 1.8], [0.0, 1.8], [0.0, 3.5], [-1.5, 3.5]], 2, 3),
}
