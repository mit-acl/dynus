...
public:
    ...
    {
        // I/O + visualization
        declare_parameter<std::string>("sfc_dir", "/home/kkondo/code/dynus_ws/src/sando/data");
        ...
        for (const auto &planner_name : planner_names)
        {
            ...
            for (int idx = 0; idx < (int)num_N_list.size(); ++idx)
            {
                ...
                else
                {
                    ...
                    base_dir = "/home/kkondo/code/dynus_ws/src/sando/benchmark_data/" + thread_string;
                }
...
private:
    ...
    void writeFactorReport() const
    {
        ...
        std::string report_path = "/home/kkondo/code/dynus_ws/src/sando/benchmark_data/"
